...
ax.set_title(f"Mean Bn Field Distribution \n {last_uploaded_inference_ace_dbn_time}")
plt.tight_layout()
...
ax.set_xlabel("longitude [deg]")
ax.set_ylabel("latitude [deg]")
ax.set_title(f"Mean Be Field Distribution \n {last_uploaded_inference_ace_dbn_time}")
plt.tight_layout()
...
ax.set_xlabel("longitude [deg]")
ax.set_ylabel("latitude [deg]")
ax.set_title(f"Standard Deviation Bn Field Distribution \n {last_uploaded_inference_ace_dbn_time}")
plt.tight_layout()
